...
class TestCompareByWeight {
	...
	void testPokemon1LessThanPokemon2() {
		...
		Pokemon pokemon2 = new Pokemon("Bidoof", 1, "NORMAL", null, "LEAFGREEN", "location", "description", 1.0, 12.5);
		PokedexItem pokedexItem2 = new PokedexItem(pokemon2);
		
		Comparator<PokedexItem> comparator = PokedexItemComparators.COMPARE_BY_WEIGHT_ASCENDING;
		assertEquals(-1, comparator.compare(pokedexItem1, pokedexItem2));
	}
	
	@Test
	void testPokemon1GreaterThanPokemmon2() {
		Pokemon pokemon1 = new Pokemon("Bidoof", 1, "NORMAL", null, "FIRERED", "location", "description", 1.0, 300.1);
		PokedexItem pokedexItem1 = new PokedexItem(pokemon1);
	...
	void testPokemonEqual() {
		...
		Pokemon pokemon2 = new Pokemon("Bidoof", 1, "NORMAL", null, "LEAFGREEN", "location", "description", 1.0, 5.2);
		PokedexItem pokedexItem2 = new PokedexItem(pokemon2);
